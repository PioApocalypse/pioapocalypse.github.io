...
== Esperienze lavorative
  * link:https://pioapocalypse.github.io/cv/informatico/#icranet[*Manutentore di rete*, title=Dettagli] presso ICRANet Pescara per conto di mailto:damiano.verzulli@soabit.com[Soabit s.r.l., title="Damiano Verzulli"] (09/01/2023 - 30/06/2023).
  * link:https://pioapocalypse.github.io/cv/informatico/#iasait[*Webmaster*, title=Dettagli] per l'A.S.D. mailto:segreteria@iasa-italia.it[IASA Italia, title="Segreteria IASA Italia"] (_sine data_, 2016 - 2021).

=== Altre esperienze
  * Esperienza di studio all'estero "*Estate INPSieme*" in Greenwich, Londra, della durata di quattro settimane (11/07/2017 - 08/08/2017). link:https://pioapocalypse.github.io/certifications/Estate_INPSieme_2017.jpg[Attestato di partecipazione., window=_blank]
// Valutare possibilità di aggiungere un curriculum solo per le mie conoscenze della lingua inglese

== Progetti personali
  * Realizzazione di un link:https://pioapocalypse.github.io/[sito personale] con CMS statico Hugo (giugno 2023 - luglio 2023).
  * Realizzazione prototipo nuovo sito per l'org. internazionale "ICRANet" con CMS statico Hugo (maggio 2023 - in corso, sospeso).
...
== Istruzione
  * (Laureando in) Laurea Triennale in Ingegneria Meccanica presso l'Università degli Studi di Salerno - CFU conseguiti 156/180 (86.7%).
...
=== Corsi di formazione (attestati)
  * "*DIGITAL MANUFACTURING - Prototipazione 3D e CNC*" (giugno 2021 - agosto 2021) - cod. prog. Formatemp "094 PROT D211 1983". link:https://pioapocalypse.github.io/certifications/Attestato_Digital_Manufacturing_Wintime_P21WT036.pdf[Attestato di frequenza., window=_blank]
  * "*Corso di Formazione Generale per i Lavoratori*" (luglio 2021) - cod. att. (link:https://opnitalialavoro.it/verifica-dellautenticita/[137413_5/15, title="Verifica autenticità", window=_blank]). link:https://pioapocalypse.github.io/certifications/Sicurezza_sul_Lavoro_P21WT036.pdf[Attestato di superamento., window=_blank]
...
=== Hard skill
  ...
  * #link:https://pioapocalypse.github.io/cv/informatico/#hardskill[Informatica]#
...
// Devo caricare da qualche parte il mio PdS e poi linkarlo qui
  * #link:https://pioapocalypse.github.io/cv/ingegnere/#hardskill[Ingegneria meccanica]#
    ...
    ** Per ulteriori dettagli, consultare la pagina del mio sito web dedicata al link:https://pioapocalypse.github.io/cv/ingegnere#cdl[curriculum come ingegnere meccanico].
...
Ritengo che i miei punti di forza siano i seguenti:
  ...
  * Precisione nello svolgere un'attività esattamente come mi è detto di fare;
  * Capacità di problem solving anche sotto pressione;
  * Pazienza e buona capacità di interfacciarmi con colleghi e compagni di squadra;
  * Buone capacità di pianificazione e gestione di routine giornaliere in ufficio.
